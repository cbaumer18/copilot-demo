...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        logger.info("Teams created and members added.")
        ...
        logger.info(f"Created {len(leaderboard_entries)} leaderboard entries.")
        ...
        logger.info(f"Created {len(workouts)} workouts.")
